...
const recipe: Recipe = {
  ...
  provenance: 'verified',
  ingredients: [
    { name: 'Toor dal', ingredientKey: 'toor_dal', quantity: 200, unit: 'g', dependable: true, adjustToTaste: false },
    { name: 'Tomato', ingredientKey: 'tomato', quantity: 3, unit: 'count', dependable: true, adjustToTaste: false },
    { name: 'Salt', ingredientKey: null, quantity: null, unit: 'g', dependable: false, adjustToTaste: true },
  ],
  steps: ['cook'],
  stepsHi: null,
};
